...
### Changed
- Increase minimum version of `sarkit` dependency


## [0.5.0] - 2026-09-01

### Changed
- CLI for Channel/TxSequence selection standardized across `cphd_plot_metadata`, `cphd_thumb`, `crsd_plot_metadata`
- Pinned `sarkit-processing` dependency
...
[unreleased]: https://github.com/ValkyrieSystems/sarkit-assurance/compare/v0.5.0...HEAD
[0.5.0]: https://github.com/ValkyrieSystems/sarkit-assurance/compare/v0.4.0...v0.5.0
[0.4.0]: https://github.com/ValkyrieSystems/sarkit-assurance/compare/v0.3.0...v0.4.0
